...
def test_matlib():
    mats = {
        0: Material({'H1': 1.0, 'K39': 1.0}, density=1.1, mat_number=1),
        1: Material({'H1': 0.1, 'O16': 1.0}, density=2.2, mat_number=2),
        2: Material({'He4': 42.0}, density=3.3, mat_numner=3),
        3: Material({'Tm171': 171.0}, density=4.4, mat_number=4),
    }
...
def test_iter():
    mats = {
        0: Material({'H1': 1.0, 'K39': 1.0}, density=42.0, mat_number=1),
        1: Material({'H1': 0.1, 'O16': 1.0}, density=43.0, mat_number=2),
        2: Material({'He4': 42.0}, density=44.0, mat_number=3),
        3: Material({'Tm171': 171.0}, density=45.0, mat_number=4),
    }
    m = gen_mesh(mats=mats)
    j = 0
